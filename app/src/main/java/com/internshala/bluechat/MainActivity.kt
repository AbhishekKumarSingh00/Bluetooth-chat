...
class MainActivity : AppCompatActivity() , DevicesRecyclerViewAdapter.ItemClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val _mw = layoutInflater.inflate(R.layout.activity_main, null)
        setContentView(_mw)
        ...
        if (savedInstanceState != null)
            alreadyAskedForPermission = savedInstanceState.getBoolean(
                PERMISSION_REQUEST_LOCATION_KEY,
                false
            )
        ...
        if (mBtAdapter == null)
            ...
            if (pairedDevices?.size ?: 0 > 0) {
                ...
                val devicesAdapter = DevicesRecyclerViewAdapter(
                    context = this,
            ...
            when (msg.what) {
                ...
                Constants.MESSAGE_WRITE -> {
                    ...
                    chatFragment.communicate(
                        com.internshala.bluechat.Message(
                            writeMessage,
                            milliSecondsTime,
                ...
                Constants.MESSAGE_TOAST -> {
                    ...
                    Snackbar.make(
                        findViewById(R.id.mainScreen),
                        msg.data.getString(Constants.TOAST).toString(), Snackbar.LENGTH_SHORT
                    ).show()
                    connected = false
                }
            }
